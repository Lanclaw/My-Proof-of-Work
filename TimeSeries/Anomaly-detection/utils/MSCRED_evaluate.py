...
parser.add_argument('--matrix_data_path', type = str, default = '../datasets/Synthetic_matrix_data/',
...
root_cause_f = open("../datasets/test_anomaly.csv", "r")
row_index = 0
...
plt.savefig('../results/mscred_anomaly_score.jpg')
plt.show()
