...
def main():
    ...
    parser.add_argument('--raw_data_file', type=str, default='../datasets/machine-1-1-data.csv')
    parser.add_argument('--label_file', type=str, default='../datasets/machine-1-1-label.csv')
    parser.add_argument('--train_data_path', type=str, default='../datasets/machine_data/machine-1-1-train')
    parser.add_argument('--test_data_path', type=str, default='../datasets/machine_data/machine-1-1-test')
    parser.add_argument('--test_start_time', type=str, default='20190923005800')
