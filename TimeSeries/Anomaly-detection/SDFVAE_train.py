...
class Trainer(object):
    ...
    def train_model(self):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            print("Epoch {} : Average Loss: {} Loglikelihood: {} KL of s: {} KL of d: {}".format(epoch + 1, meanloss,
                                                                                                 meanllh, means, meand))
...
def main():
    ...
    parser.add_argument('--checkpoints_path', type=str, default='model/sdfvae_machine-1-1')
    parser.add_argument('--checkpoints_file', type=str, default='')
    parser.add_argument('--checkpoints_interval', type=int, default=10)
    parser.add_argument('--log_path', type=str, default='results/sdfvae_log_trainer/machine-1-1')
